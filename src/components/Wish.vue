<template>
  <div>
    <v-container class="d-flex">
      <v-text-field class="mx-auto mr-2" variant="outlined" placeholder="Name" width="30" v-model="wish.name"></v-text-field>
      <v-text-field class="mx-auto mr-2" variant="outlined" placeholder="Description" width="200" v-model="wish.description"></v-text-field>
      <v-btn color="blue" rounded="0" icon="mdi-link" class="mx-auto d-block mr-2 mt-1 wish-buttons" @click="dialog = true"></v-btn>
